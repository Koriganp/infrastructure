...
<html lang="en-US">
	...
	<body>
		...
		<p>Venus, 37, is the Albuquerque Infrastructure Manager who is responsible for managing all incoming 311
			...
			the job. She has a Masters' in Civil Engineering and applies her knowledge to further the betterment of the
			city's infrastructure.</p>
		<h2>User Tech</h2>
		<p class = "story"><strong>Technology:</strong> Dell Desktop, iPad, Dell Laptop, LG smartphone</p>
		<h2>Frustrations</h2>
